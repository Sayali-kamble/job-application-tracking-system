...
Recruiters, on the other hand, rely on spreadsheets or scattered tools, making it difficult to track candidates and hiring progress.

This project provides a **role-based Application Tracking System** where:  
